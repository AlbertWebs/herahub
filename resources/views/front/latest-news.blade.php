          ...
          <div class="row">
            ...
            <div class="col-md-8">
                          ...
                          <div class="blog-simple">
							<a href="#"><img class="img-responsive" src="{{asset('theme/img/blog/cover_bg_1.jpg')}}" alt=""></a>
							<div class="blog-text">
									<h3 class="big-heading"><a href="#">Web Design for the Future</a></h3>
...
pri quando everti electram ei, ex homero omittam salutatus sed.
						...
						<div class="blog-simple">
							<a href="#"><img class="img-responsive" src="{{asset('theme/img/blog/cover_bg_2.jpg')}}" alt=""></a>
							<div class="blog-text">
									<h3 class="big-heading"><a href="#">Web Design for the Future</a></h3>
									<span class="user-post"><i class="ti-user"></i>Jhony Dono</span>
									<span class="date-post"><i class="ti-calendar"></i>Sep. 15th</span>
...
pri quando everti electram ei, ex homero omittam salutatus sed.
						...
						<div class="blog-simple">
							<a href="#"><img class="img-responsive" src="{{asset('theme/img/blog/cover_bg_3.jpg')}}" alt=""></a>
							<div class="blog-text">
									<h3 class="big-heading"><a href="#">Web Design for the Future</a></h3>
									<span class="user-post"><i class="ti-user"></i>Jhony Dono</span>
									<span class="date-post"><i class="ti-calendar"></i>Sep. 15th</span>
            ...
            <div class="col-md-4">
              ...
              <form role="search">
                ...
                <div class="widget">
                  ...
                  <div class="recent">
                    <div>
                      <img alt="#" class="pull-left" src="{{asset('theme/img/blog/65x65/thumb1.jpg')}}">
                      <h6>
                    ...
                    <div>
                      <a href="#"><img alt="#" class="pull-left" src="{{asset('theme/img/blog/65x65/thumb2.jpg')}}"></a>
                      <h6>
                    ...
                    <div>
                      <a href="#"><img alt="#" class="pull-left" src="{{asset('theme/img/blog/65x65/thumb3.jpg')}}"></a>
                      <h6>
